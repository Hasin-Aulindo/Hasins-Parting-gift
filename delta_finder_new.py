...
# Read both CSV files
file1 = pd.read_csv('file1_new.csv')
file2 = pd.read_csv('file2_new.csv')
...
# Standardize date format (without time)
...
# Find rows in file2 but not in file1 (Additions)
